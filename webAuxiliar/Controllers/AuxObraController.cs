            ...
            if (_search)
            {
                switch (searchField)
                {
                    case "by_numeroAux":
                        ...
                        break;
                    case "by_contratista":
                        listaAuxObra = listaAuxObra.Where(t => t.Contratista.ToUpper().Contains(searchString)).ToList();
                        break;
                    case "by_objetoCto":
                        listaAuxObra = listaAuxObra.Where(t => t.ObjetoCto.Contains(searchString)).ToList();
                        break;
                }
            }
